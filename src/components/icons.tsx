...
const iconProps = {
  className: "w-6 h-6 mb-1 text-teal-400 group-hover:text-teal-300 transition-colors",
  strokeWidth: 1.5,
};
...
const imageIconProps = {
  className: "w-6 h-6 mb-1 text-red-400 group-hover:text-red-300 transition-colors",
  strokeWidth: 1.5,
};
